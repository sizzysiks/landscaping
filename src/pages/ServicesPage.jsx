...
import ServicesPageContent from "../components/services-page/ServicesPageContent"

export default function ServicesPage ({ menuIsOpen, setMenuIsOpen }){
